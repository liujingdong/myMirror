package com.example.dllo.mirror.customview;
...
//      setBackgroundColor(mBgColor);
    ...
    public void setOriginalInfo(int width, int height, int locationX, int locationY) {
        ...
        // 所以不用定位该视图的位置,如果不是的话，还需要定位视图的位置，然后计算mOriginalLocationX和mOriginalLocationY
        mOriginalLocationY = mOriginalLocationY - getStatusBarHeight(getContext());//减去状态栏的高度
    }
