package com.example.dllo.mirror.sunglasses;
 ...
 */
public class SunGlassesFragment extends BaseFragment implements View.OnClickListener {
    private TextView sunGlassesTv;
    @Override
    public int setLayout() {
        return R.layout.fragment_sun_glasses;
    }

    @Override
    public void initView(View view) {
        sunGlassesTv = findView(R.id.fragment_sun_glasses_tv);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.fragment_sun_glasses_tv:
                //获取通知栏的高度
                Rect frame = new Rect();
